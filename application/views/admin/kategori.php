												...
												<div class="custom_dropdown_list">
													...
													<ul class="custom_list clc">
														...
														<?php foreach ($data as $val): ?>
															<li><a href="<?php echo site_url('prodak/kategori/').$val->id_kategori ?>" class="clc" data-id="<?php echo $val->id_kategori ?>" onclick="kate()""><?php echo $val->kategori ?> <i class="fas fa-chevron-right ml-auto"></i></a></li>
														<?php endforeach ?>
		...
		<div class="deals_featured">
			<div class="container">
				...
				<?php if ($this->session->flashdata('er')): ?>
					...
					<div class="alert alert-primary px-5 py-5 mt-5" style="border: none"><h4><?php echo $this->session->flashdata('er'); ?></h4></div>
				<?php endif ?>
				
				<div class="row" id="kat_hide">
